...
public class Product {
    @PrimaryKey
    @NonNull
    String  name_of_announcement;
    String url_of_the_announcement_dimensions, url_of_the_announcement_image, price_of_announcement, type_of_announcement;
    String composition_of_announcement, durability_of_announcement,color_of_announcement;
    Product(){

    }
    public Product(String name_of_announcement, String url_of_the_announcement_dimensions, String url_of_the_announcement_image, String price_of_announcement, String type_of_announcement, String composition_of_announcement, String durability_of_announcement,String color_of_announcement) {
